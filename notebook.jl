...
# ╔═╡ 9085b0eb-be5b-4f58-9839-9d42eab4a856
using CSV,
    DataFrames,
    Plots,
    LinearAlgebra,
...
# ╔═╡ 993ac9a2-a957-11ec-05ec-3f6df68d3b2d
md"""
...
# ╔═╡ 79fe928e-65c8-4a73-8bdb-a0b1ff288d29
md"""
...
# ╔═╡ d623fca1-1f16-4b53-8412-2a87f312dbf5
md"""
...
# ╔═╡ 83062391-cd42-48cb-8ca4-75c1b7ae7c12
md"""
...
# ╔═╡ d65189b1-f215-4ff4-b9af-eeb1817e9e41
...
# ╔═╡ 43d65d86-86f0-422a-b627-577ebc104c40
...
# ╔═╡ 89d2e2d2-4ed5-47ec-ba89-32fc3fc21984
plot(BTCtrain); plot!(f₇, 1:N)

# ╔═╡ 8226ad69-f425-47b8-8780-e0bab99df982
md"""
Ok. Could be worse…
...
# ╔═╡ f29c5938-f6a4-46b4-bf66-5e28c1d98440
md"""
Other polynomials don't seem like an improvement… but if we take a close look we'll see that ``f₅`` and ``f₆`` are extremely close.

Let's check those in more detail
"""

# ╔═╡ 18f32845-7f54-4b89-a7be-35000f9197c7
begin
...
# ╔═╡ 51ad7cd5-0d33-420f-832c-782ab1720558
md"""
Let's see how well these predict the real price of Bitcoin during the last week
"""

# ╔═╡ 5b180580-d7f1-4559-bb5f-327c00349621
const interval = length(BTCtrain):(length(BTCtrain)+5)

# ╔═╡ 3439c7d8-0f10-403b-aa59-82e63f2a3bed
test_residuals(f) = abs.(BTCtest - f.(interval));

# ╔═╡ 33473d9b-9ac9-4fba-a9be-09ffc73e15de
mean(test_residuals(fs[6]))

# ╔═╡ 4affd81a-7f82-4856-baee-69af52c1f925
mean(test_residuals(fs[6]))

# ╔═╡ 869afda5-c684-4f40-b1c9-376d813400a4
mean(test_residuals(fs[7]))

# ╔═╡ 7449ac9c-2a02-44ad-a672-28edab25c15d
md"""
We can see that for the three functions, the residual will be around \$1000 during the week. This doesn't seem too bad for an asset being traded at around \$40000, but it probably isn't enough to give us a competitive strategy.
"""

# ╔═╡ 17a67752-498b-4ee8-8188-9a6f0ce6d1ba
md"""
## 3. Is the Bitcoin price related to the price of hard commodities?
"""

# ╔═╡ 3f0f1b48-7445-4dbf-9e2f-1ae1306638e0
md"""
...
# ╔═╡ b0dd1715-0f78-407b-9dec-7a6ef55c3fce
begin
...
# ╔═╡ 09066895-7996-4937-b75b-7b50c8dd9663
md"""
Now let's plot the data to see if there ...
"""

# ╔═╡ 748ff2e6-f51a-401e-8041-2e6ab9735990
md"""
...
# ╔═╡ 45930f81-0aad-4a02-aa76-e34250c0b66b
begin
...
# ╔═╡ c34d7949-6677-4ddb-9fd2-64d6dc4c4fda
begin
...
# ╔═╡ 014c25d6-15a6-443d-a0a4-52941930cfbc


# ╔═╡ 1b658351-19e9-4753-9a00-fca02ea982dc
md"""
## REFERECES
